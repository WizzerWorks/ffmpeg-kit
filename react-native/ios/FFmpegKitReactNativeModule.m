...
- (instancetype)init {
    ...
    if (self) {
        ...
        [FFmpegKitReactNativeModule registerGlobalCallbacks];
    }
...
RCT_EXPORT_METHOD(addListener:(NSString*)eventName) {
  NSLog(@"Listener added for %@ event.\n", eventName);
}
...
RCT_EXPORT_METHOD(abstractSessionGetEndTime:(int)sessionId (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
...
RCT_EXPORT_METHOD(abstractSessionGetDuration:(int)sessionId (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    id<Session> session = [FFmpegKitConfig getSession:sessionId];
    if (session == nil) {
      reject(@"SESSION_NOT_FOUND", @"Session not found.", nil);
    } else {
      resolve([session getDuration]);
    }
}

RCT_EXPORT_METHOD(abstractSessionGetAllLogs:(int)sessionId withTimeout:(int)waitTimeout (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    id<Session> session = [FFmpegKitConfig getSession:sessionId];
    if (session == nil) {
      reject(@"SESSION_NOT_FOUND", @"Session not found.", nil);
    } else {
      int timeout;
      if ([self isValidPositiveNumber:waitTimeout]) {
        timeout = waitTimeout;
      } else {
...
RCT_EXPORT_METHOD(abstractSessionGetLogs:(int)sessionId (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    id<Session> session = [FFmpegKitConfig getSession:sessionId];
    if (session == nil) {
      reject(@"SESSION_NOT_FOUND", @"Session not found.", nil);
    } else {
...
RCT_EXPORT_METHOD(abstractSessionGetAllLogsAsString:(int)sessionId withTimeout:(int)waitTimeout (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    id<Session> session = [FFmpegKitConfig getSession:sessionId];
    if (session == nil) {
      reject(@"SESSION_NOT_FOUND", @"Session not found.", nil);
    } else {
      ...
      NSString* allLogsAsString = [session getAllLogsAsString:timeout];
      resolve(allLogsAsString);
    }
}

RCT_EXPORT_METHOD(abstractSessionGetState:(int)sessionId (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    id<Session> session = [FFmpegKitConfig getSession:sessionId];
    if (session == nil) {
      reject(@"SESSION_NOT_FOUND", @"Session not found.", nil);
    } else {
...
RCT_EXPORT_METHOD(abstractSessionGetReturnCode:(int)sessionId (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    id<Session> session = [FFmpegKitConfig getSession:sessionId];
    if (session == nil) {
      reject(@"SESSION_NOT_FOUND", @"Session not found.", nil);
    } else {
...
RCT_EXPORT_METHOD(abstractSessionGetFailStackTrace:(int)sessionId (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    id<Session> session = [FFmpegKitConfig getSession:sessionId];
    if (session == nil) {
      reject(@"SESSION_NOT_FOUND", @"Session not found.", nil);
    } else {
...
RCT_EXPORT_METHOD(thereAreAsynchronousMessagesInTransmit:(int)sessionId (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    id<Session> session = [FFmpegKitConfig getSession:sessionId];
    if (session == nil) {
      reject(@"SESSION_NOT_FOUND", @"Session not found.", nil);
    } else {
      resolve([session thereAreAsynchronousMessagesInTransmit]);
    }
}
...
RCT_EXPORT_METHOD(ffmpegSession:(NSArray*)arguments (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
...
RCT_EXPORT_METHOD(ffmpegSessionGetAllStatistics:(int)sessionId withTimeout:(int)waitTimeout (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    id<Session> session = [FFmpegKitConfig getSession:sessionId];
    if (session == nil) {
      reject(@"SESSION_NOT_FOUND", @"Session not found.", nil);
    } else {
        if ([session isMemberOfClass:[FFmpegSession class]]) {
            ...
            NSArray* allStatistics = [session getAllStatisticsWithTimeout:timeout];
...
RCT_EXPORT_METHOD(ffmpegSessionGetStatistics:(int)sessionId (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    id<Session> session = [FFmpegKitConfig getSession:sessionId];
    if (session == nil) {
      reject(@"SESSION_NOT_FOUND", @"Session not found.", nil);
    } else {
...
RCT_EXPORT_METHOD(ffprobeSession:(NSArray*)arguments (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
...
RCT_EXPORT_METHOD(mediaInformationSession:(NSArray*)arguments (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
...
RCT_EXPORT_METHOD(mediaInformationJsonParserFrom:(NSString*)ffprobeJsonOutput (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    NSError *error;
...
RCT_EXPORT_METHOD(mediaInformationJsonParserFromWithError:(NSString*)ffprobeJsonOutput (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    NSError *error;
    MediaInformation* mediaInformation = [MediaInformationJsonParser from:ffprobeJsonOutput with:error];
    if (error == nil) {
        resolve([FFmpegKitReactNativeModule toMediaInformationDictionary:mediaInformation]);
...
RCT_EXPORT_METHOD(enableRedirection:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    [FFmpegKitReactNativeModule enableLogs];
    [FFmpegKitReactNativeModule enableStatistics];
...
RCT_EXPORT_METHOD(disableLogs:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    [FFmpegKitReactNativeModule disableLogs];
...
RCT_EXPORT_METHOD(disableStatistics:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    [FFmpegKitReactNativeModule disableStatistics];

    resolve(nil);
}

RCT_EXPORT_METHOD(setFontconfigConfigurationPath:(NSString*)path (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    [FFmpegKitConfig setFontconfigConfigurationPath:path];

    resolve(nil);
}

RCT_EXPORT_METHOD(setFontDirectory:(NSString*)fontDirectoryPath with:(NSDictionary*)fontNameMap (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    [FFmpegKitConfig setFontDirectory:fontDirectoryPath with:fontNameMap];

    resolve(nil);
}

RCT_EXPORT_METHOD(setFontDirectoryList:(NSArray*)fontDirectoryList with:(NSDictionary*)fontNameMap (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
...
RCT_EXPORT_METHOD(closeFFmpegPipe:(NSString*)ffmpegPipePath (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
...
RCT_EXPORT_METHOD(isLTSBuild:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    resolve([FFmpegKitConfig isLTSBuild] == 1);
}
...
RCT_EXPORT_METHOD(setEnvironmentVariable:(NSString*)variableName with:(NSString*)variableValue (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    [FFmpegKitConfig setEnvironmentVariable:variableName value:variableValue];

    resolve(nil);
}

RCT_EXPORT_METHOD(ignoreSignal:(int)signalValue (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    ...
    if (session == nil) {
      reject(@"SESSION_NOT_FOUND", @"Session not found.", nil);
        ...
        if ([session isMemberOfClass:[MediaInformationSession class]]) {
            ...
            [FFmpegKitConfig asyncGetMediaInformationExecute:session withTimeout:timeout];
            resolve(nil);
        } else {
...
RCT_EXPORT_METHOD(getLogLevel:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    resolve([FFmpegKitConfig getLogLevel]);
}

RCT_EXPORT_METHOD(setLogLevel:(int)level (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
...
RCT_EXPORT_METHOD(getSessionHistorySize:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    resolve([FFmpegKitConfig getSessionHistorySize]);
}

RCT_EXPORT_METHOD(setSessionHistorySize:(int)sessionHistorySize (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    [FFmpegKitConfig setSessionHistorySize:sessionHistorySize];
    resolve(nil);
}

RCT_EXPORT_METHOD(getSession:(int)sessionId (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    id<Session> session = [FFmpegKitConfig getSession:sessionId];
    if (session == nil) {
        reject(@"SESSION_NOT_FOUND", @"Session not found.", nil);
    } else {
...
RCT_EXPORT_METHOD(getSessionsByState:(int)sessionState (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
...
RCT_EXPORT_METHOD(getLogRedirectionStrategy:(RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    resolve([FFmpegKitReactNativeModule getLogRedirectionStrategy);
}

RCT_EXPORT_METHOD(setLogRedirectionStrategy:(int)logRedirectionStrategy (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    [FFmpegKitConfig setLogRedirectionStrategy:logRedirectionStrategy];
    resolve(nil);
}

RCT_EXPORT_METHOD(messagesInTransmit:(int)sessionId (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    resolve([FFmpegKitConfig messagesInTransmit:sessionId]);
}
...
RCT_EXPORT_METHOD(selectDocument:(BOOL)writable title:(NSString*)title type:(NSString*)type array:(NSArray*)extraTypes (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
  reject(@"Not Supported", @"Not supported on iOS platform.", nil);
}

RCT_EXPORT_METHOD(getSafParameter:(BOOL)writable uri:(NSString*)uriString (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
  reject(@"Not Supported", @"Not supported on iOS platform.", nil);
}
...
RCT_EXPORT_METHOD(cancelSession:(int)sessionId (RCTPromiseResolveBlock)resolve rejecter:(RCTPromiseRejectBlock)reject) {
    ...
    if (session != nil) {
        ...
        if ([session isFFprobe]) {
          if ([session isMemberOfClass:[MediaInformationSession class]]) {
            ...
            dictionary[KEY_SESSION_TYPE] = SESSION_TYPE_MEDIA_INFORMATION;
          } else {
            dictionary[KEY_SESSION_TYPE] = SESSION_TYPE_FFPROBE;
          }
        } else {
          dictionary[KEY_SESSION_TYPE] = SESSION_TYPE_FFMPEG;
        }
